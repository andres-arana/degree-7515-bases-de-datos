...
\begin{figure}[h!t]
  \centering
\includegraphics[width=1.3\textwidth, angle=90]{build/images/der.png}
...
CARRERA(\uline{Número, EncuentroNumero}, Tipo, EstadoPista, EstadoTiempo, SexoEquinos, Distancia, PistaNombre, PistaHipódromoNombre)

EQUINO(\uline{Nombre}, Tipo, Pelaje, Sexo, Handicap, StudNombre, PadreNombre, MadreNombre, CuidadorPersonaDNI, EntrenadorPersonaDNI)

PARTICIPACIÓN(\uline{JockeyPersonaDNI, EquinoNombre, CarreraNúmero, CarreraEncuentroNúmero}, Tiempo, Andarivel, PesoJockey, TallaJockey, HandicapEquino)
...
\begin{figure}[h!t]
  \centering
  \includegraphics[width=1.4\textwidth, angle=90]{build/images/rel.png}
