...
Representa a los equinos que podrán participar en los distintos encuentros representando a un stud.

\begin{itemize}

  \item \textbf{\uline{Nombre}} Nombre del equino.
    
  \item \textbf{Tipo} 
  
  \item \textbf{Pelaje} Indica el color de pelaje que posee.
  
  \item \textbf{Sexo} Sexo del equino.
  
  \item \textbf{Handicap} Representa el handicap.
   
  \item \textbf{StudNombre} Nombre del stud al que pertenece.
  
  \item \textbf{PadreNombre} Nombre del padre.
  
  \item \textbf{MadreNombre} Nombre de la madre.
  
  \item \textbf{CuidadorPersonaDNI} Indica el dni de su cuidador.
  
  \item \textbf{EntrenadorPersonaDNI} Indica el dni de su entrenador.
...
Representa los resultados de un jockey y un equino en las distintas carreras, guardando el tiempo que les tomó finalizarlas. 

\begin{itemize}

  \item \textbf{\uline{JockeyPersonaDNI}} Dni del jockey que montó al equino.
  
  \item \textbf{\uline{EquinoNombre}} Nombre del equino que corrió la carrera.
  
  \item \textbf{\uline{CarreraNúmero}} Identificador de la carrera.
  
  \item \textbf{\uline{CarreraEncuentroNúmero}} Número del encuentro en el que se había programado la carrera.
  
  \item \textbf{StudNombre} Nombre del stud al que pertenece.
  
  \item \textbf{Tiempo} Representa el tiempo que tardó el equino en llegar a la meta.
  
  \item \textbf{Andarivel} Indica el andarivel en donde corrió el equino.
  ...
  \item \textbf{HandicapEquino} Handicap que poseía el equino al correr la carrera.
...
\begin{itemize}
	...
	\item \textbf{StudNombre} Nombre del stud para el que trabaja la persona.
	
\end{itemize}

\subsection{Jockey}

Representa a los encargados de montar los equinos en las distintas carreras de los encuentros disputados en los hipódromos representando a un stud.

\begin{itemize}

	\item \textbf{\uline{PersonaDNI}} Dni del jockey.
	
	\item \textbf{Categoría} Categoría en la cual puede competir.
...
Representa las entidades dueñas de uno o varios equinos que correrán en los distintos encuentros.

\begin{itemize}

	\item \textbf{\uline{Nombre}} Nombre del stud.
	
	\item \textbf{ColorGorra} Color de la gorra que usarán los jockeys que representen al stud en una carrera.
	
	\item \textbf{ColorChaqueta} Color de la chaqueta que usarán los jockeys que representen al stud en una carrera.
